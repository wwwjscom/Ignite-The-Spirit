...
if (flash6 || flash7) document.write("<object classid=clsid:d27cdb6e-ae6d-11cf-96b8-444553540000 width=757 height=242><param name=allowScriptAccess value=sameDomain><param name=movie value=home_hdr.swf?section=home><param name=quality value=high><param name=bgcolor value=ffffff><embed src=home_hdr.swf?section=home quality=high bgcolor=ffffff width=757 height=242 allowScriptAccess=sameDomain type=application/x-shockwave-flash></object><br>");
else document.write("<iframe src=images/index_noflash.aspx width=757 height=197 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling=no></iframe><br>");
</script>
...
<legend>Applicant Information</legend>
	...
	<div class="optional">
		<label for="state">State:</label> Illinois
	</div>
	<div class="optional">
...
<legend>Parent Information</legend>
	...
	<div class="optional">
		<label for="first_name">Parent 1 First Name:</label>
		<input type="text" name="first_name" id="first_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">Parent 1 Last Name:</label>
		<input type="text" name="last_name" id="last_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">Parent 1 Phone:</label>
		<input type="text" name="last_name" id="last_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">CFD Company Assignment:</label>
		<input type="text" name="last_name" id="last_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional"></div>
	<div class="optional">
		<label for="first_name">Parent 2 First Name:</label>
		<input type="text" name="first_name" id="first_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">Parent 2 Last Name:</label>
		<input type="text" name="last_name" id="last_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">Parent 2 Phone:</label>
		<input type="text" name="last_name" id="last_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">CFD Company Assignment:</label>
...
<legend>School Information</legend>
	...
	<div class="optional">
		<label for="first_name">Current School:</label>
		<input type="text" name="first_name" id="first_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
		<label for="last_name">High School you will attend:</label>
		<input type="text" name="last_name" id="last_name" class="inputText" size="10" maxlength="100" value="" />
	</div>
	<div class="optional">
