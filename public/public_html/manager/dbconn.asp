...
<table border=0 cellpadding=0 cellspacing=0>
	<tr>
		...
		<td width=532 valign=top bgcolor=e5e5e5>
			...
			<img src=lilshimmy.gif height=15><br>
			<center><font size="18"><i><b>2007 Calendar coming soon!</i></b></font></center>
			<span class=norm>
			...
			sda.SelectCommand = new SqlCommand("select item_number, item_name, price, item_description, thumbnail from fire_products", dbconn);
