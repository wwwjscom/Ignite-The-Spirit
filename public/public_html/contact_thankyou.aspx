...
<html>
<%
String messtext = "Name: " + Request["name"] + "\n";
messtext = messtext + "Email: " + Request["email"] + "\n";
messtext = messtext + "Comment: " + Request["comment"] + "\n";
MailMessage mess = new MailMessage();
mess.To = "admin@ignitethespirit.org";
mess.Cc = "richpinskey@aol.com";
mess.From = "admin@ignitethespirit.org";
mess.Subject = "message from the i.t.s. contact form";
mess.Body = messtext;
		...
		<td width=364 valign=top bgcolor=e5e5e5>
			...
			<table border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td width=349>
						<span class=norm>
						Thank you for your interest in Ignite the Spirit. We will respond to your inquiry via email. Your support is appreciated!<br>
						</span>
					</td>
				</tr>
			</table>
